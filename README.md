...
**Shizuku is an optional third-party app.**

When Shizuku is connected and O.status is authorised, **Auto** can follow the current system status-bar appearance and dynamically switch the indicator between black and white.

Without Shizuku, **Auto** continues to work using your phone's system theme:
...
> Dynamic Auto requires Shizuku, a third-party app, to enable status bar colour detection.
